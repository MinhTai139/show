...
import com.example.duan_android.CheckConnection;
import com.example.duan_android.R;
import com.example.duan_android.Server;
...
public class LoginActivity extends AppCompatActivity {
                            ...
                            try {
                                ...
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    if (serverEmail.equals(email) && serverPassword.equals(password)) {
                                        ...
                                        saveUserInfo(userId, userName, userDiemThuong);
    ...
    private void saveUserInfo(String id, String name, String diemThuong) {
